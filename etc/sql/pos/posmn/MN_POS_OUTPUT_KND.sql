CREATE TABLE `MN_POS_OUTPUT_KND`
(
    `POS_OUTPUT_KND_PID`  int          NOT NULL AUTO_INCREMENT COMMENT '포스_출력물_종류_순번',
    `STORE_UNQCODE`       varchar(14)  NOT NULL COMMENT '매장_고유코드',
    `POS_OUTPUT_KND_CODE` varchar(7)   NOT NULL COMMENT '포스_출력물_종류_코드',
    `POS_OUTPUT_KND_NM`   varchar(50)  NOT NULL COMMENT '포스_출력물_종류_명',
    ...
    PRIMARY KEY (`POS_OUTPUT_KND_PID`),
    INDEX mn_pos_output_knd_idx (`STORE_UNQCODE`, `CREATED_AT`)
) ENGINE = InnoDB
